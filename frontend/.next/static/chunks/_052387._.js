...
const LoginPage = ()=>{
    ...
    const [load, setLoad] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (data.success) {
                ...
                router.push('/search');
            } else __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(data.message);
        } catch (error) {
            console.error(error);
...
_s(LoginPage, "yUvycivQBpV0g+ss4eXcHhe1B9Q=", false, function() {
    return [
